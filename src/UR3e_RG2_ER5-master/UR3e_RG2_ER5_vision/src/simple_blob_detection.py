...
def blob_detect(image,                  #-- The frame (cv standard)
    ...
    # this help remove partical left by thresholding 
    ...
    #  ------------------------------------------------------------------------------tuning-- link in the tutorial for more info
...
#==========================================================================================================
#====================EVERY FUNCTION ABOVE IS BORROWED===================================================        
#====================CODE BELOW IS FROM simple_camera.py================================================
...
if __name__=="__main__":
    ...
    while True:
        ...
        #---Apply blob_detect function----------------
        keypoints, _ = blob_detect(RGB_image, blue_min, blue_max, blur=3, blob_params=None, search_window=window, imshow=False)
        RGB_image = draw_window(RGB_image, window)
        draw_keypoints(RGB_image, keypoints, imshow=True)
