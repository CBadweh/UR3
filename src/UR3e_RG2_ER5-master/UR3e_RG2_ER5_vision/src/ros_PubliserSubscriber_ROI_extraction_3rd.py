...
class PubSub(object):
    ...
    def callback(self, data):
        ...
        # # ============BACKGROUND SUBTRACTION ON ROI_IMAGE ====================
        # # Stop updating background subtraction after if (frame_count < frame_max)
        # if(empty == 1):
        #     rospy.loginfo("Empty")
        #     self.frame_count = 0 
        #     self.flag =0
        ...
        # else:
        #     rospy.loginfo("Not Empty")
        #     if(self.frame_count < self.frame_max):
        #         rospy.loginfo("Processing BackGround Subtraction")
        #         self.frame_count += 1
        #         rospy.loginfo("image frame count:  %s", self.frame_count )
        #         self.roi_bgs = self.bgs.apply(roi_img_cropped);
        #         # cv2.imshow("roi_bgSubtract", self.roi_bgs)
        #         self.flag =1 
        ...
        # if(self.flag ==1):
        #     rospy.loginfo("BackGround Subtraction Flag")
        #     cv2.imshow("roi_bgSubtract", self.roi_bgs)
